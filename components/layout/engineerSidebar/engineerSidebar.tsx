...
export function EngineerSidebar() {
  return (
    <aside className="hidden w-64 shrink-0 self-stretch border-e border-border bg-surface lg:flex lg:flex-col">
      <div className="sticky top-0 flex max-h-dvh flex-1 flex-col gap-6 overflow-y-auto px-4 py-5">
